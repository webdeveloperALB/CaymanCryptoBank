...
const BalanceCard = memo(
  ({
    ...
    <Card className="hover:shadow-md transition-all duration-200 bg-[#2A3F78] relative overflow-hidden h-[120px] sm:h-[140px]">
...
function DashboardContent({
  ...
  const getActivityColor = useCallback((activity: CombinedActivity) => {
    // Use neutral colors with #2A3F78 accent
    return "border-gray-200 bg-gray-50/30 hover:border-[#2A3F78]/30";
  }, []);

  const getPriorityColor = useCallback((priority: string) => {
    switch (priority) {
      case "urgent":
        return "bg-[#2A3F78] text-white border-[#2A3F78]";
      case "high":
        return "bg-[#2A3F78]/20 text-[#2A3F78] border-[#2A3F78]/30";
      case "normal":
      ...
      return (
        <div
          ...
          className={`transition-all duration-200 hover:bg-gray-50/50 ${getActivityColor(
            activity
          )} border-l-4 hover:border-l-[#2A3F78]`}
        >
              ...
              <div className="flex items-start space-x-3 flex-1 min-w-0">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-white shadow-sm flex items-center justify-center flex-shrink-0 border-2 border-gray-100">
                  {React.cloneElement(getActivityIcon(activity), {
                    className: "h-4 w-4 sm:h-5 sm:w-5 text-[#2A3F78]",
                  })}
                </div>
                    ...
                    <div className="mb-3 sm:mb-4">
                      ...
                      {shouldShowExpand && (
                        <Button
                          ...
                          className="mt-2 text-[#2A3F78] hover:text-[#2A3F78] hover:bg-[#2A3F78]/10 p-0 h-auto font-medium text-xs sm:text-sm"
                        >
                          {isExpanded ? (
                            <>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-6 sm:mb-8">
          <Button
            ...
            className="h-12 sm:h-16 bg-[#2A3F78] hover:bg-[#2A3F78]/90 text-white text-sm sm:text-base"
          >
          ...
          <Button
            ...
            variant="outline"
            className="h-12 sm:h-16 text-sm sm:text-base bg-transparent border-[#2A3F78] text-[#2A3F78] hover:bg-[#2A3F78] hover:text-white"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="lg:col-span-1 space-y-4 sm:space-y-6">
            ...
            <Card className="shadow-lg border-0">
              <CardHeader className="bg-[#2A3F78] border-b p-4 sm:p-6">
                <CardTitle className="flex items-center text-base sm:text-lg text-white">
                  <Activity className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-white" />
                  Account Activity
                </CardTitle>
              </CardHeader>
                    ...
                    {combinedActivities.length > 3 && (
                      <div className="p-4 text-center border-t border-gray-100">
                        <Button
                          ...
                          className="text-[#2A3F78] hover:text-[#2A3F78] hover:bg-[#2A3F78]/10 font-medium"
                        >
                          {showAllActivities ? (
                            <>
