        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <button
              ...
              className="group bg-white border-2 border-gray-200 rounded-xl p-8 text-left transition-all hover:border-[#2A3F78] hover:shadow-md focus:outline-none focus:border-[#2A3F78] focus:shadow-md"
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-orange-50 transition-colors">
                  <Bitcoin className="w-8 h-8 text-gray-600 group-hover:text-[#2A3F78] transition-colors" />
                </div>
                <div>
            ...
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-orange-50 transition-colors">
                  <Building2 className="w-8 h-8 text-gray-600 group-hover:text-[#2A3F78] transition-colors" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
                    Bank Transfer
