  ...
  return (
    <>
      ...
      <div
        className={`
          fixed md:relative
          w-64 bg-blue-50 h-screen flex flex-col
      ...
      >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-0 py-4 text-left transition-all duration-200 relative ${
                      activeTab === item.id
                        ? "text-[#2A3F78]"
                        : item.isEnabled
                        ? "text-gray-800 hover:text-[#2A3F78] hover:bg-gray-200/50"
        ...
        <div className="p-6 flex-shrink-0 border-t border-gray-200/50">
          <div className="bg-[#2A3F78] rounded-2xl px-4 py-3 text-white relative">
