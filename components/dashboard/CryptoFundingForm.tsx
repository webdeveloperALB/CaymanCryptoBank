    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <button
            onClick={onBack}
            className="flex items-center gap-2 px-6 py-3 bg-[#2A3F78] text-white rounded-lg hover:bg-[#1F2A56] transition-colors"
          >
        ...
        {currentStep === 3 ? (
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl p-12 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    <span className="text-[#2A3F78] mt-1">•</span>
              ...
              <button
                onClick={onBack}
                className="px-8 py-3 bg-[#2A3F78] text-white rounded-lg hover:bg-[#1F2A56] transition-colors font-medium"
              >
                Return to Dashboard
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-[#2A3F78] focus:border-transparent"
                />
              </div>
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  className="mt-1 w-4 h-4 rounded border-gray-300 text-[#2A3F78] focus:ring-[#2A3F78]"
                />
                <label htmlFor="terms" className="text-sm text-gray-700">
                  I am 18 years of age or older and agree to the{' '}
                  <a href="#" className="text-[#2A3F78] hover:underline">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 flex flex-col items-center justify-center">
            <div className="w-full max-w-md">
              ...
              <div className="bg-white p-8 rounded-xl mb-6 flex justify-center">
                {isLoadingWallets ? (
                  <div className="w-64 h-64 flex items-center justify-center">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#2A3F78]"></div>
                  </div>
              ...
              <div className="flex items-center justify-center gap-2">
                <button className="px-4 py-2 bg-[#2A3F78] text-white rounded-lg text-sm font-medium">
                  Amount
                </button>
        ...
        <div className="mt-8 flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-[#2A3F78] rounded-full flex items-center justify-center text-white text-sm font-semibold">
              1
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-semibold ${currentStep >= 2 ? 'bg-[#2A3F78]' : 'bg-gray-300'}`}>
              2
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-semibold ${currentStep >= 3 ? 'bg-[#2A3F78]' : 'bg-gray-300'}`}>
              3
            </div>
          </div>
        </div>
